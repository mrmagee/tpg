  ...
  if($settings['bbcode'] == 1)
   {
	...
	$bbcode->addCode ('s', 'simple_replace', null, array ('start_tag' => '<s>', 'end_tag' => '</s>'), 'inline', array ('listitem', 'block', 'inline', 'link', 'quote', 'pre', 'monospace'), array ());
    ...
    $bbcode->addCode ('youtube', 'simple_replace', null, array ('start_tag' => '<embed src="http://www.youtube.com/v/', 'end_tag' => '&hl=en&fs=1" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="560" height="450" ></embed>'), 'inline', array ('listitem', 'block', 'inline', 'link', 'quote', 'pre', 'monospace'), array ());
	$bbcode->addCode ('gs', 'simple_replace', null, array ('start_tag' => '<div align="center"><iframe width="95%" height="500" frameborder="0" src="https://spreadsheets.google.com/', 'end_tag' => '">IFRAME Not Available. <a href="https://spreadsheets.google.com/{param}">Link to Spreadsheet.</a></iframe></div>'), 'inline', array ('listitem', 'block', 'inline', 'link', 'quote', 'pre', 'monospace'), array ());
